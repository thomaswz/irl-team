// Script to load users into Firebase production
...
// NO emulator connections - this will connect to production Firebase

async function createUser(email, password, role) {
  try {
    // Create user using Firebase SDK
...
async function loadUsers() {
  console.log('🚀 Loading users and roles into Firebase PRODUCTION...')
  console.log('⚠️  WARNING: This will create users in your production Firebase project!')
